                                    ...
                                    <div className="space-y-4 mb-6">
                                        ...
                                        <div className="flex items-start justify-between p-4 bg-slate-50 rounded-lg">
                                            ...
                                            <button
                                                ...
                                                className={`w-12 h-7 rounded-full transition-colors flex items-center ${preferences.functional ? 'bg-emerald-500 justify-end' : 'bg-slate-300 justify-start'
                                                    } px-1`}
                                            >
                                        ...
                                        <div className="flex items-start justify-between p-4 bg-slate-50 rounded-lg">
                                            ...
                                            <button
                                                ...
                                                className={`w-12 h-7 rounded-full transition-colors flex items-center ${preferences.analytics ? 'bg-emerald-500 justify-end' : 'bg-slate-300 justify-start'
                                                    } px-1`}
                                            >
                                                <div className="w-5 h-5 bg-white rounded-full shadow" />
                                            </button>
